(function () {
  ...
  // Spin animation and result with gradual slowdown
  function spinAnimation(wonDiscount) {
    ...
    let step = 0;
    let speed = spinAngle / steps; // Initial speed
    ...
    const animate = setInterval(() => {
      ...
      speed *= 0.98; // Reduce speed by 2% on each step for smooth deceleration
